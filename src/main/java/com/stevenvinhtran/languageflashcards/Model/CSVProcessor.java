...
public class CSVProcessor {
    ...
    public static ArrayList<String> loadSettings() {
        ...
        try {
            List<String> lines = readCSV(FLASHCARD_CSV_PATH, Arrays.asList("term,definition,type,reviewDate,dateAdded,repetitions,easeFactor,interval,isNewCard"));
    ...
    public static void updateFlashcard(Flashcard old, Flashcard updated) {
        ...
        try {
            List<String> csvLines = readCSV(FLASHCARD_CSV_PATH, Arrays.asList("term,definition,type,reviewDate,dateAdded,repetitions,easeFactor,interval,isNewCard"));
